...
#### 🔷 1. Устанавливаем для пользователя переменную $LFS. 
В файле ~/.bashrc прописываем
```
export LFS=/mnt/lfs
```
...
wget https://github.com/libexpat/libexpat/releases/download/R_2_4_6/expat-2.4.6.tar.gz --continue --directory-prefix=$LFS/sources
```
...
Логинимся как пользователь lfs
```
su - lfs
```
Создаем файл .bash_profile и вставляем в него следующую строку
```
...
Создаем и устанавливаем следующее содержимое файла .bashrc
```
set +h
umask 022
LFS=/mnt/lfs
