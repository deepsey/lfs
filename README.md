...
12. Устанавливаем права на каталог /mnt/lfs
```
chown -R lfs:lfs /mnt/lfs
```
13.  Устанавливаем дополнительные права на папку sources 1777 (стики бит - все пользователи хоста будут иметь право создавать файлы в каталоге sources (но не удалять))
```
